...
## 📖 Table of Contents
1.  **[Architecture Deep-Dive](file:///r:/Obsidian/COMPUTER/.obsidian/plugins/colorful-folders/docs/ARCHITECTURE.md)**: The "engine" behind the styles.
2.  **[Data & Schema](file:///r:/Obsidian/COMPUTER/.obsidian/plugins/colorful-folders/docs/DATA_SCHEMA.md)**: How settings are stored and resolved.
3.  **[UI & Styling System](file:///r:/Obsidian/COMPUTER/.obsidian/plugins/colorful-folders/docs/STYLE_GUIDE.md)**: Design tokens, CSS-in-TS, and animations.
4.  **[API Reference](file:///r:/Obsidian/COMPUTER/.obsidian/plugins/colorful-folders/docs/API_REFERENCE.md)**: Detailed class and method documentation.
5.  **[Feature Implementation Guide](file:///r:/Obsidian/COMPUTER/.obsidian/plugins/colorful-folders/docs/CONTRIBUTING.md)**: Step-by-step instructions for common tasks.
6.  **[Engine Internals](file:///r:/Obsidian/COMPUTER/.obsidian/plugins/colorful-folders/docs/ENGINE_INTERNALS.md)**: Absolute low-level logic and debugging.
