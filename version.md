...
- **WYSIWYG Color Picker Previews**: The color picker preview block now actively matches the actual Obsidian tree view rendering logic, providing a true 1:1 preview.
