...
var ColorPickerModal = class extends obsidian.Modal {
  ...
  onOpen() {
    ...
    opSlider.min = "0";
    opSlider.max = "100";
    opSlider.value = String(Math.round((this.folderStyle.opacity ?? 1) * 100));
    ...
    const traverse = (folder, depth, rootIndex = 0, passedColor = null, inheritedStyle = null) => {
      ...
      if (passedColor || this.settings.autoColorFiles || this.settings.autoIcons || this.settings.notebookNavigatorSupport && this.settings.notebookNavigatorFileBackground) {
        ...
        for (const child of copyFiles) {
          ...
          const op = fileStyle?.opacity !== void 0 ? fileStyle.opacity : isCustomColor && activeStyle?.opacity !== void 0 ? activeStyle.opacity : 1;
          ...
          const isBold = fileStyle?.isBold !== void 0 ? fileStyle.isBold : inheritedStyle?.applyToFiles ? inheritedStyle.isBold : false;
          const isItalic = fileStyle?.isItalic !== void 0 ? fileStyle.isItalic : inheritedStyle?.applyToFiles ? inheritedStyle.isItalic : false;
          ...
          if (iconId) {
            const isCustomEmoji = !obsidian8.getIconIds?.().includes(`lucide-${iconId}`) && !obsidian8.getIconIds?.().includes(iconId) && !(this.settings.customIcons && this.settings.customIcons[iconId]);
            if (isCustomEmoji) {
              css += `
      ...
      for (let i = 0; i < copyFolders.length; i++) {
        ...
        const bgNN = nnS.b;
        const textNN = nnS.t;
        const isBold = customStyle?.isBold !== void 0 ? customStyle.isBold : inheritedStyle?.isBold !== void 0 ? inheritedStyle.isBold : true;
        const isItalic = customStyle?.isItalic !== void 0 ? customStyle.isItalic : inheritedStyle?.isItalic !== void 0 ? inheritedStyle.isItalic : false;
        let textCss = `
        ...
        if (activeStyle && activeStyle.iconId) {
          const isCustomEmoji = !obsidian8.getIconIds?.().includes(`lucide-${activeStyle.iconId}`) && !obsidian8.getIconIds?.().includes(activeStyle.iconId) && !this.settings.customIcons[activeStyle.iconId];
          if (isCustomEmoji) {
            css += `
...
var _DividerManager = class {
  ...
  buildDividerNode(path, conf) {
    ...
    const iconIds = obsidian9.getIconIds?.() || [];
...
var ColorfulFoldersPlugin = class extends obsidian10.Plugin {
  ...
  styleObserver = null;
  dividerManager;
  isSyncingDividers = false;
  processDividersDebounced;
  async onload() {
